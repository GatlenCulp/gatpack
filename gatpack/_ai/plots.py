"""Command-line plotting utilities for gatpack.

Usage:
    $ python -m gatpack.plots [--input-path PATH] [--output-path PATH]
"""
...
from gatpack.config import FIGURES_DIR, PROCESSED_DATA_DIR
